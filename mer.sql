...
CREATE TABLE IF NOT EXISTS `proyinf4`.`noticias` (
  `noticiaid` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `deporteid` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `proyinf4`.`subscripciones` (
  `idSubscripcion` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `usuarioid` INT UNSIGNED NULL,
  `equipoid` INT UNSIGNED NULL,
  `fecha` DATE NULL,
  ...
  CONSTRAINT `usuarioid1`
    ...
    REFERENCES `proyinf4`.`usuarios` (`usuarioid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
